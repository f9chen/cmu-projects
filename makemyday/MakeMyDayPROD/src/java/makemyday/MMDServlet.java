    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (zip != null && radius != null) {
            ...
            try {
                ...
                jsonString = jb.build();
                System.out.println("==============\n" + jsonString);
                response.sendRedirect("/MakeMyDayPROD/options.jsp");
            } catch (Exception e) {
                e.printStackTrace();
                /*
                 ...
                 * response.setContentType("application/json"); // Get the
                 * printwriter object from response to write the required json
                 * object to the output stream PrintWriter out =
                 * response.getWriter(); // Assuming your json object is
                 * **jsonObject**, perform the following, it will return your
                 * json object out.print(jsonString); out.flush();
                 */
            }
        } else {
